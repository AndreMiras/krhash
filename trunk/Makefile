...
# Generated by qmake (2.01a) (Qt 4.4.2) on: Tue Sep 30 18:25:57 2008
# Project:  krhash.pro
# Template: app
...
SOURCES       = main.cpp \
		...
		moc_ConfigBruteForceWidget.cpp \
...
compiler_moc_header_make_all: moc_MainWindow.cpp moc_AbstractAttack.cpp moc_HashListWidget.cpp moc_InfoWidget.cpp moc_ConfigAttackDialog.cpp moc_ConfigBruteForceWidget.cpp moc_ConfigDictionaryWidget.cpp moc_ConfigAbstractAttackWidget.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_MainWindow.cpp moc_AbstractAttack.cpp moc_HashListWidget.cpp moc_InfoWidget.cpp moc_ConfigAttackDialog.cpp moc_ConfigBruteForceWidget.cpp moc_ConfigDictionaryWidget.cpp moc_ConfigAbstractAttackWidget.cpp
...
moc_ConfigAttackDialog.cpp: ConfigBruteForceWidget.h \
		ConfigAbstractAttackWidget.h \
		AbstractAttack.h \
		AbstractAlgo.h \
		ConfigDictionaryWidget.h \
...
moc_ConfigBruteForceWidget.cpp: ConfigAbstractAttackWidget.h \
		AbstractAttack.h \
		AbstractAlgo.h \
		ConfigBruteForceWidget.h
	/usr/bin/moc $(DEFINES) $(INCPATH) ConfigBruteForceWidget.h -o moc_ConfigBruteForceWidget.cpp
...
AlgoMd2.o: AlgoMd2.cpp AlgoMd2.h \
		AbstractAlgo.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o AlgoMd2.o AlgoMd2.cpp
...
AlgoSha0.o: AlgoSha0.cpp AlgoSha0.h \
		AbstractAlgo.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o AlgoSha0.o AlgoSha0.cpp
...
AlgoNtlm.o: AlgoNtlm.cpp AlgoNtlm.h \
		AbstractAlgo.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o AlgoNtlm.o AlgoNtlm.cpp

AbstractAttack.o: AbstractAttack.cpp AbstractAttack.h \
		AbstractAlgo.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o AbstractAttack.o AbstractAttack.cpp

BruteForceAttack.o: BruteForceAttack.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o BruteForceAttack.o BruteForceAttack.cpp
...
ConfigBruteForceWidget.o: ConfigBruteForceWidget.cpp ConfigBruteForceWidget.h \
		ConfigAbstractAttackWidget.h \
		AbstractAttack.h \
		AbstractAlgo.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o ConfigBruteForceWidget.o ConfigBruteForceWidget.cpp
...
moc_ConfigBruteForceWidget.o: moc_ConfigBruteForceWidget.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_ConfigBruteForceWidget.o moc_ConfigBruteForceWidget.cpp
